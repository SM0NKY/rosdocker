...
{
  new (message_memory) cpp_pubsub_adv::msg::Status(_init);
}

void Status_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cpp_pubsub_adv::msg::Status *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Status_message_member_array[2] = {
  {
    ...
    offsetof(cpp_pubsub_adv::msg::Status, estado),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cpp_pubsub_adv::msg::Status, nivel),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Status_message_members = {
  "cpp_pubsub_adv::msg",  // message namespace
  "Status",  // message name
  2,  // number of fields
  sizeof(cpp_pubsub_adv::msg::Status),
...
get_message_type_support_handle<cpp_pubsub_adv::msg::Status>()
{
  return &::cpp_pubsub_adv::msg::rosidl_typesupport_introspection_cpp::Status_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cpp_pubsub_adv, msg, Status)() {
  return &::cpp_pubsub_adv::msg::rosidl_typesupport_introspection_cpp::Status_message_type_support_handle;
}
