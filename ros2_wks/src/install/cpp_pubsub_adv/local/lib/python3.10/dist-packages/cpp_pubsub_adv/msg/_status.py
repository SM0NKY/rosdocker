...
class Metaclass_Status(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('cpp_pubsub_adv')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'cpp_pubsub_adv.msg.Status')
            logger.debug(
...
class Status(metaclass=Metaclass_Status):
    ...
    def __init__(self, **kwargs):
        ...
        self.estado = kwargs.get('estado', str())
        self.nivel = kwargs.get('nivel', int())
    ...
    def estado(self, value):
        if __debug__:
            assert \
                ...
                "The 'estado' field must be of type 'str'"
        self._estado = value
    ...
    def nivel(self, value):
        if __debug__:
            assert \
                ...
                "The 'nivel' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'nivel' field must be an integer in [-2147483648, 2147483647]"
        self._nivel = value
